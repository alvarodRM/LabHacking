...
print("\n")
subprocess.run(["vagrant", "suspend", f"vm1_{dni}_{dificultad}", f"vm2_{dni}_{dificultad}", f"vm3_{dni}_{dificultad}", f"vm4_{dni}_{dificultad}", f"vm5_{dni}_{dificultad}"])
print("\n")