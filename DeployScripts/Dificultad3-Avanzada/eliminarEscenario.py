...
print("\n")
subprocess.run(["vagrant", "destroy", "-f", f"vm1_{dni}_{dificultad}", f"vm2_{dni}_{dificultad}", f"vm3_{dni}_{dificultad}", f"vm4_{dni}_{dificultad}", f"vm5_{dni}_{dificultad}", f"vm6_{dni}_{dificultad}", f"vm7_{dni}_{dificultad}", f"vm8_{dni}_{dificultad}", f"vm9_{dni}_{dificultad}", f"vm10_{dni}_{dificultad}"])
print("\n")