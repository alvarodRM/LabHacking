...
print("LABORATORIO NIVEL DE DIFICULTAD: AVANZADA")
print("\n")
...
print("- Tienes que localizar las 9 banderas ocultas en el escenario.")
print("- Las banderas están distribuidas a lo largo de tres redes internas (RED PRUEBAS, RED PREPRODUCCION y RED PRODUCCION).")
print("- Se necesitarán emplear técnicas de pivotaje entre redes en el nivel de dificultad avanzada del escenario.")
...
print("- Para la última prueba del laboratorio tendrás que programar un ransomware utilizando python. Se recomienda utilizar la biblioteca/módulo cryptography.fernet de python.")
...
print("- Bandera 9: +1 punto.")
print("- Ejecución del ransomware: +1 punto.")
print("- Preguntas y respuestas: +2 puntos.")
print("*En el nivel de dificultad avanzada del laboratorio la puntuación máxima es de (10/10).")
print("\n")